...
public class Trade {
	...
	public Trade(String a, String b) {
		this.a = a;
		this.b = b;
		Bukkit.getPlayer(a).performCommand("mgcs off");
		Bukkit.getPlayer(b).performCommand("mgcs off");
	...
	public void checkTrade(){
		if(bA && bB){
			...
			Bukkit.getPlayer(a).performCommand("mgcs on");
			Bukkit.getPlayer(b).performCommand("mgcs on");
